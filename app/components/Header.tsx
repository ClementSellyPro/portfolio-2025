...
export default function Header() {
  ...
  return (
    <motion.header 
      ...
      className='relative z-[60] flex justify-between lg:px-24 px-10 lg:pt-18 pt-8'>
      <div className='logo-name text-[#272727] select-none flex flex-col lg:text-4xl text-xl h-fit relative z-30'><span>CLEMENT</span> <span>SELLY</span></div>
